...
public class ReaderManager {
  private final Scanner scanner;
    ...
    public Reader[] changeReader(Reader[] readers) {
        ...
        System.out.print("Заменить? (yes/nou): ");
        ...
        if("yes".equals(task)){
            System.out.print("Введи новую фамилию: ");
        ...
        task = scanner.nextLine();
        if("yes".equals(task)){
            System.out.print("Введи новый номер телефона: ");
            readers[numberReader - 1].setPhone(scanner.nextLine());
        }
        System.out.println(readers[numberReader - 1].toString()+"Измененный читатель: ");
        return readers;
